...
namespace InteractionScripts
{
    ...
    public class LoreItem : MonoBehaviourPun
    {
        ...
        public void Pickup(PlayerInventory inventory)
        {
            ...
            photonView.RPC("MarkAsDiscoveredForAll", RpcTarget.AllBuffered, itemName);
        ...
        [PunRPC]
        private void MarkAsDiscoveredForAll(string loreName)
        {
            if (loreDatabase != null)
                loreDatabase.MarkAsDiscovered(loreName);
        }
